...
Stack: `Expo Web` `Node.js` `Express` `Supabase/PostgreSQL` `JWT` · Includes: Dockerfile, docker-compose, `.env.example`, production verification script
...
Stack: `Python` `Playwright` `pytest` `Telegram Bot API` · Real generated image outputs included in repo
